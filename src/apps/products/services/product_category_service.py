...
class ProductCategoryUpdateService:
    def product_category_update(self, instance: ProductCategory, dto: ProductCategoryEntity) -> ProductCategory:
    ...
    def _build_product_category_dto_from_request_data(cls, instance: ProductCategory, request_data: OrderedDict) -> ProductCategoryUpdateEntity:
        serializer = ProductCategoryInputSerializer(instance, data=request_data, partial=True)
        serializer.is_valid(raise_exception=True)
    ...
    def update_category(self, request_data: OrderedDict, instance: ProductCategory) -> ProductCategory:
        ...
        category_dto = self._build_product_category_dto_from_request_data(instance, request_data)
