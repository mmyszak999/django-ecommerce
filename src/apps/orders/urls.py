...
urlpatterns = [
    path(
        "carts/",
        CartListCreateAPIView.as_view({"get": "list", "post": "create"}),
        name="cart-list",
    ),
    path(
        "carts/<uuid:pk>/",
        CartDetailAPIView.as_view({"delete": "destroy", "get": "retrieve"}),
        name="cart-detail",
    ),
    path(
        "carts/<uuid:pk>/items/",
    ...
    path(
        "carts/<uuid:pk>/order/",
        OrderCreateAPIView.as_view({"post": "create"}),
        name="create-order",
    ),
    path("orders/", OrderListAPIView.as_view({"get": "list"}), name="order-list"),
    path(
        "orders/<uuid:pk>/",
        OrderDetailAPIView.as_view({"get": "retrieve"}),
        name="order-detail",
    ),
    path(
        "most-ordered-products/",
        MostOrderedProductsListAPIView.as_view({"get": "list"}),
        name="most-ordered-proudcts-list",
    ),
]
